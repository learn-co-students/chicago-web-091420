...
class BagelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bagel" do
    assert_difference('Bagel.count') do
      post bagels_url, params: { bagel: { name: @bagel.name, price: @bagel.price, tasty: @bagel.tasty } }
    end
  ...
  test "should update bagel" do
    patch bagel_url(@bagel), params: { bagel: { name: @bagel.name, price: @bagel.price, tasty: @bagel.tasty } }
